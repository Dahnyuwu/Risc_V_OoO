...
add wave -noupdate -expand -group RS_Disp /Issue_Queue_TB/Disp_rs1_TAG
add wave -noupdate -expand -group RS_Disp /Issue_Queue_TB/disp_rs1_data
add wave -noupdate -expand -group RS_Disp /Issue_Queue_TB/Disp_rs2_TAG
add wave -noupdate -expand -group RS_Disp /Issue_Queue_TB/disp_rs2_data
...
WaveRestoreCursors {{Cursor 1} {4976 ns} 0}
...
update
WaveRestoreZoom {4921 ns} {5005 ns}
