    ...
    assign  {rs1_va_in3_, rs1_data_in3_, rs2_va_in3_, rs2_data_in3_, s_ena3_, u_ena3_} =    ({disp_valid, cdb_va} == 2'b00) ? {dONTCARE_[0], dONTCARE_, dONTCARE_[0], dONTCARE_, 2'b00} :   // Keep
                                                                                            ...
                                                                                            ({disp_valid, cdb_va} == 2'b11) ? ((~issue_full) ? ((((~disp_rs1_tag_va) && (disp_rs1_tag == cdb_tag)) && (~disp_rs2_tag_va) && (disp_rs2_tag == cdb_tag))  ? {cdb_va, cdb_data, cdb_va, cdb_data, 2'b11} :                              // Update Rs1, Rs2
                                                                                                                                                 ...
                                                                                                                                                 ((~disp_rs2_tag_va) && (disp_rs2_tag == cdb_tag))                                                      ? {disp_rs1_tag_va, disp_rs1_data, cdb_va, cdb_data, 2'b11} :                // Shift and Update Rs2
                                                                                                                                                                                                                                                          {disp_rs1_tag_va, disp_rs1_data, disp_rs2_tag_va, disp_rs2_data, 2'b11}) : // Shift
                                                                                                                                               ...
                                                                                                                                               ((((~disp_rs1_tag_va) && (disp_rs1_tag == cdb_tag)) && (~disp_rs2_tag_va) && (disp_rs2_tag == cdb_tag))  ? {cdb_va, cdb_data, cdb_va, cdb_data, 2'b01} :                 // Update Rs1, Rs2
                                                                                                                                                 ((~disp_rs1_tag_va) && (disp_rs1_tag == cdb_tag))                                                      ? {cdb_va, cdb_data, rs2_va_out3_, rs2_data_out3_, 2'b01} :     // Update and Update Rs1
                                                                                                                                                 ((~disp_rs2_tag_va) && (disp_rs2_tag == cdb_tag))                                                      ? {rs1_va_out3_, rs1_data_out3_, cdb_va, cdb_data, 2'b01} :     // Update and Update Rs2
                                                                                                                                                                                                                                                          {dONTCARE_[0], dONTCARE_, dONTCARE_[0], dONTCARE_, 2'b00})) : // No match
                                                                                                                                                                                                                                                           68'b0;                                                       // Default
    ...
    assign  {rs1_va_in2_, rs1_data_in2_, rs2_va_in2_, rs2_data_in2_, s_ena2_, u_ena2_} =    ({disp_valid, cdb_va} == 2'b00) ? {dONTCARE_[0], dONTCARE_, dONTCARE_[0], dONTCARE_, 2'b00} :   // Keep
                                                                                            ...
                                                                                            ({disp_valid, cdb_va} == 2'b11) ? ((~(valid_out2_ & valid_out1_ & valid_out0_)) ? ((((~rs1_va_out3_) && (rs1_tag_out3_ == cdb_tag)) && (~rs2_va_out3_) && (rs2_tag_out3_ == cdb_tag)) ? {cdb_va, cdb_data, cdb_va, cdb_data, 2'b11} :                           // Update Rs1, Rs2
                                                                                                                                                                                ...
                                                                                                                                                                                ((~rs2_va_out3_) && (rs2_tag_out3_ == cdb_tag))                                                   ? {rs1_va_out3_, rs1_data_out3_, cdb_va, cdb_data, 2'b11} :               // Shift and Update Rs2
                                                                                                                                                                                                                                                                                    {rs1_va_out3_, rs1_data_out3_, rs2_va_out3_, rs2_data_out3_, 2'b11}) :  // Shift
...
// Update and shift sr1
    assign  {rs1_va_in1_, rs1_data_in1_, rs2_va_in1_, rs2_data_in1_, s_ena1_, u_ena1_} =    ({disp_valid, cdb_va} == 2'b00) ? {dONTCARE_[0], dONTCARE_, dONTCARE_[0], dONTCARE_, 2'b00} :   // Keep
                                                                                            ...
                                                                                            ({disp_valid, cdb_va} == 2'b11) ? ((~(valid_out1_ & valid_out0_)) ? ((((~rs1_va_out2_) && (rs1_tag_out2_ == cdb_tag)) && (~rs2_va_out1_) && (rs2_tag_out1_ == cdb_tag))  ? {cdb_va, cdb_data, cdb_va, cdb_data, 2'b11} :                            // Update Rs1, Rs2
                                                                                                                                                                  ...
                                                                                                                                                                  ((~rs2_va_out2_) && (rs2_tag_out2_ == cdb_tag))                                                    ? {rs1_va_out2_, rs1_data_out2_, cdb_va, cdb_data, 2'b11} :                // Shift and Update Rs2
                                                                                                                                                                                                                                                                        {rs1_va_out2_, rs1_data_out2_, rs2_va_out2_, rs2_data_out2_, 2'b11}) :  // Shift
    ...
    assign  {rs1_va_in0_, rs1_data_in0_, rs2_va_in0_, rs2_data_in0_, s_ena0_, u_ena0_} =    ({disp_valid, cdb_va} == 2'b00) ? {dONTCARE_[0], dONTCARE_, dONTCARE_[0], dONTCARE_, 2'b00} :   // Keep
                                                                                            ...
                                                                                            ({disp_valid, cdb_va} == 2'b11) ? ((~valid_out0_) ? ((((~rs1_va_out1_) && (rs1_tag_out1_ == cdb_tag)) && (~rs2_va_out1_) && (rs2_tag_out1_ == cdb_tag)) ? {cdb_va, cdb_data, cdb_va, cdb_data, 2'b11} :                             // Update Rs1, Rs2
                                                                                                                                                  ...
                                                                                                                                                  ((~rs2_va_out1_) && (rs2_tag_out1_ == cdb_tag))                                                   ? {rs1_va_out1_, rs1_data_out1_, cdb_va, cdb_data, 2'b11} :                 // Shift and Update Rs2
                                                                                                                                                                                                                                                      {rs1_va_out1_, rs1_data_out1_, rs2_va_out1_, rs2_data_out1_, 2'b11}) :    // Shift
